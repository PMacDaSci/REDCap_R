...
On this course we will be making use of a collection of packages designed for data science called the **`tidyverse`** that make it much easier and more fun to work with your data. After installing R and RStudio, follow the instructions below to
...
Workshop Outline: Analysing a REDCap Dataset in R with tidyREDCap

Audience: Clinicians with little to no programming experience (very beginners)
Duration: 2 sessions of 2.5 hours each (including a 15-minute break per session)

Session 1: Introduction to R and Handling REDCap Data

1. Welcome and Workshop Overview (15 min)
	•	Introduction to the workshop and objectives
	•	Overview of R and RStudio interface
	•	Understanding R scripts and the console

2. Importing REDCap Data via API with tidyREDCap (60 min)
	•	Understanding API access in REDCap
	•	What is an API, and why use it?
	•	REDCap API tokens: how to request one
	•	Setting API permissions in REDCap
	•	Using tidyREDCap to Connect to REDCap
	•	Loading required libraries (tidyREDCap, REDCapR, httr)
	•	Setting up API tokens securely
	•	Importing data using redcap_project_info() and redcap_read_oneshot()
...
Does this structure align with your workshop goals? Let me know if you’d like any refinements!